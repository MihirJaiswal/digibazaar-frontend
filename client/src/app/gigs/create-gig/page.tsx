  ...
  const GigPreview = () => (
    <div className="rounded-xl overflow-hidden border shadow-lg bg-card">
      <div className="h-48 bg-muted relative">
        {formData.cover ? (
          <img src={formData.cover || "/placeholder.svg"} alt={formData.title} className="w-full h-full object-cover" />
        ) : (
      ...
      <div className="p-5">
        <h3 className="font-semibold text-lg line-clamp-2 mb-2">{formData.title || "Your Gig Title"}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Showcase your skills and start earning</p>
            </div>
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-lg overflow-hidden">
                ...
                <CardFooter className="px-6 py-4 bg-muted/20 border-t flex justify-between">
                  <Button variant="outline" onClick={handleBack} disabled={step === 1} className="gap-1">
              ...
              <div className="sticky top-6">
                ...
                <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-amber-800 dark:text-amber-400">Tips for a great gig</h4>
