        ...
        <Card className="shadow-lg">
          <CardHeader className="space-y-1 bg-muted/30">
            ...
            <CardDescription className="text-center">
              Provide a delivery proof for order #{gigOrderId?.toString().slice(0, 8)}
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Provide a publicly accessible link to your work. This could be a photo of your shipping label,
                  a screenshot of tracking information, a PDF invoice, or a digital file (via Google Drive, Dropbox, etc.)
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Include any instructions or notes for the buyer (e.g., details about the delivery, tracking information, etc.)"
                  rows={5}
                />
              </div>
            </form>
