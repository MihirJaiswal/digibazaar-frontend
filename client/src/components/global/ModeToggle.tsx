...
export function ModeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative h-10 w-10 rounded-full border-2 border-slate-100 dark:border-zinc-800 bg-white dark:bg-zinc-950 transition-colors duration-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 focus:outline-none"
