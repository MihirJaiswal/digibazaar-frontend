...
import BannerSection from "./default/Hero"
import FeaturedCollectionSection from "./default/Product"
import AboutSection from "./default/About"
import NewsletterSection from "./default/Newsletter"
import FooterSection from "./default/Footer"
...
function DefaultTemplateInternal({
  storeName,
  storeDescription,
  products,
  storeLogo,
  ...
  const handleProcessPayment = async () => {
    ...
    try {
      const paymentIntentRes = await fetch(`/orders/payments/create-intent`, {
        method: "POST",
        headers: {
