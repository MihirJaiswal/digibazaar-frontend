...
import BannerSection from "./modern/Hero"
import FeaturedCollectionSection from "./modern/Product"
import AboutSection from "./modern/About"
import NewsletterSection from "./modern/Newsletter"
import FooterSection from "./modern/Footer"
  ...
  return (
    ...
    >
      ...
      <AboutSection
        ...
        backgroundColor2={themeCustomization?.backgroundColor2 || "#f9fafb"}
      ...
      <FooterSection
        storeLogo={storeLogo}
        storeName={storeName}
        footerText={themeCustomization?.footerText || "Thank you for visiting our store"}
        borderColor={themeCustomization?.borderColor || "#333333"}
        footerBarColor={themeCustomization?.navBarColor || "rgba(0, 0, 0, 0.85)"}
      />
    </div>
  )
}
