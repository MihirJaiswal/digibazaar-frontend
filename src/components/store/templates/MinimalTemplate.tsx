...
import BannerSection from "./minimal/Hero"
import FeaturedCollectionSection from "./minimal/Products"
import AboutSection from "./minimal/About"
import NewsletterSection from "./minimal/Newsletter"
import FooterSection from "./minimal/Footer"
...
function MinimalTemplateInternal({
  ...
  return (
    ...
    >
      ...
      <AboutSection
        backgroundColor={themeCustomization?.backgroundColor2 || "#f9fafb"}
